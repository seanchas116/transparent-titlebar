...
const setRepresentedFilenameButton = document.getElementById('setRepresentedFilename')
...
setTitleButton.addEventListener('click', () => {
  ...
  if (title) {
    ...
    transparentTitlebar.setTitleColor(remote.getCurrentWindow().getNativeWindowHandle(), ...color)
  }
})
